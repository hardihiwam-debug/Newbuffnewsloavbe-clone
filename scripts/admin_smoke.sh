...
echo "[1/6] PIN gate — wrong PIN should be 403 / 'Incorrect PIN'"
...
echo "[2/6] verifyPin correct PIN → 200 {\"ok\":true,...}"
...
echo "[5/6] listTranslationKeys → 200, includes geminiUsage array"
...
echo "[6/6] listTranslationModels → 200, includes gemini-3.6-flash"
